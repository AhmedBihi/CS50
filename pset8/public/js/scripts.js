...
{
    var mapLatLng = new google.maps.LatLng(parseFloat(place.latitude), parseFloat(place.longitude));
...
function articles(marker, query)
{
    ...
    // creates and unordered list of articles with links inside the showInfo() window
    ...
    .done(function(data, textStatus, jqXHR) {
        ...
        if (data.length > 0) {
            articles = "<ul>";
            articles += "<LH><b>" + query + " local news:" + "</b></LH>";
